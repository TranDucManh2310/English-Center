      ...
      return `<tr>
        <td>
          <div style="display:flex;align-items:center;gap:8px;">
            ...
            <div><div style="font-size:12px;font-weight:700;color:#0f172a;">${escapeHtml(row.title)}</div><div style="font-size:10px;color:#94a3b8;">${dateLabel(row.submittedAt || row.createdAt, true)} - ${escapeHtml(row.teacherName || "")}</div></div>
          </div>
        </td>
